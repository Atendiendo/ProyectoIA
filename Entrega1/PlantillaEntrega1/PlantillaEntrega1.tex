...
desarrollan un algoritmo de Branch and Cut específicamente diseñado para este problema, que generaliza el Problema de la Ruta
Rentable (PTP) al incorporar tiempos de viaje variables para modelar la congestión vial. Proponen una formulación de
...
La evidencia sugiere que los enfoques híbridos y las metaheurísticas avanzadas (especialmente VNS/ALNS y
estrategias similares) son los más adecuados para resolver el EPTP de manera efectiva. Su flexibilidad para incorporar múltiples
restricciones, su capacidad para escapar de óptimos locales y su eficiencia computacional relativa las hacen superiores. El método de
\cite{article} es una prueba concreta de este éxito en el EPTP, mientras que los resultados de \cite{6552660} en el OPTW (un
problema muy similar en espíritu al EPTP) lo corroboran.
