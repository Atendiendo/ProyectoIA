...
El siguiente modelo matematico fue creado usando \cite{article} y el documento entregado por el ayudante asociado al problema Marcel
Silva.
...
como diferencias fundamentales en su enfoque, las cuales se presentan a continuacion.

Las técnicas existentes se \textbf{asemejan} en su objetivo común de maximizar la rentabilidad en problemas de enrutamiento selectivo, y
en la necesidad de balancear la exploración y explotación del espacio de búsqueda. Particularmente, métodos como VNS/ALNS \cite{6552660} y
el enfoque híbrido de \cite{article} comparten estrategias similares de búsqueda local adaptativa y mecanismos para mantener la factibilidad
frente a restricciones operativas.

Sin embargo, las metodologías \textbf{difieren} crucialmente en su escalabilidad y su capacidad para manejar dichas restricciones
operativas. Los métodos exactos \cite{LERAROMERO2021879} quedan limitados a instancias pequeñas debido a la complejidad NP-Hard,
siendo inviables en escenarios reales. Las heurísticas simples priorizan la velocidad sobre la calidad y a menudo fallan al integrar
adecuadamente las ventanas de tiempo (VT), generando soluciones infactibles o de bajo rendimiento, especialmente para problemas como
el Orienteering Problem con VT (OPTW). En contraste, los enfoques híbridos (como VNS/ALNS) \cite{6552660} son los más adecuados, ya
que combinan la potencia de búsqueda con mecanismos explícitos de reparación y mantenimiento de la factibilidad.
